    ...
    <form onSubmit={handleSubmit} className={compact ? "" : "mb-4"}>
      ...
      <div className="flex items-center justify-end gap-2 mt-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 bg-primary hover:bg-primary-hover text-white text-sm font-bold disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
